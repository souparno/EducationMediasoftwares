...
namespace exam
{
    public partial class frm_master_test : Form
    {
        ...
        {
            if (class_Application.flag == 1 && textBox2.Text != null)
            {
                s = null;
                s = "insert into test_master(exam_code,test_code,test_name) values('" + exam_code.ToUpper() + "','" + test_code.ToUpper() + "','" + textBox2.Text.ToUpper() + "');";
            ...
            {
                s = null;
                s = "update test_master set test_name='"+ textBox2.Text.ToUpper() +"' where exam_code='"+ exam_code.ToUpper() +"' and test_code='"+ test_code.ToUpper() +"'";
                ob.execute_non_query(s);
                fill_grid();
            }
