...
public partial class Account_Admin_ReviewTest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string user_id = ddl_Users.SelectedValue;
            string test_id = ddl_test_name.SelectedValue;
            ViewState["_user_id"] = user_id;
    ...
    private void fill_ddl_users()
    {
        SqlConnection con = new SqlConnection(_connection);
        string sql = "select usr_id,usr_name from oes_user_master;";
        SqlDataAdapter da = new SqlDataAdapter(sql, con);
        DataTable dt = new DataTable();
        da.Fill(dt);

        ddl_Users.DataSource = dt;
        ddl_Users.DataTextField = "usr_name";
        ddl_Users.DataValueField = "usr_id";
        ddl_Users.DataBind();
    ...
    protected void btnview_result_Click(object sender, EventArgs e)
    {
        ...
        string user_id = Convert.ToString(ViewState["_user_id"]);
