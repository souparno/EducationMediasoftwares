...
namespace exam
{
    public partial class frm_insert_Image : Form
    {
        ...
        {     
                class_Application.frm_master_question.Questiongrid.Rows[ROW].Cells[COLUMN].Value = txt_question.Text;
                class_Application.frm_master_question.Questiongrid.Rows[ROW].Cells[COLUMN+1].Value = 1;
                this.Close();
